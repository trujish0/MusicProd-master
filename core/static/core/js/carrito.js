...
class Carrito {
    ...
    insertarCarrito(producto) {
        ...
        row.innerHTML = `
            ...
            <td>
                <a href="#" class="borrar-producto carrito fas fa-times-circle" data-id="${producto.id}"></a>
            </td>
        `;
    ...
    eliminarProducto(e) {
        ...
        if (e.target.classList.contains('carrito')) {
            this.eliminarProductoLocalStorage(productoID, 0);
        } else {
            this.eliminarProductoLocalStorage(productoID, 1);
        }
        this.calcularTotal();
    ...
    eliminarProductoLocalStorage(productoID, alert) {
        let productosLS;
